...
- **Enhanced monitoring**
  ...
  - Difference between CloudWatch and Enhanced Monitoring
    - CloudWatch gathers metrics about CPU utilisation from the _hypervisor_ for the DB instance
    - Enhanced Monitoring gathers its metrics from an _agent_ on the DB instance
