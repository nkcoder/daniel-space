...
- _Answer_: use AWS Config to set up a rule in the AWS account.
...
- Supports domain name stateful network traffic inspection by creating _Allow_ lists and _Deny_ lists
